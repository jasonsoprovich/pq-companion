...
- **Recipe Browser** — Browse tradeskill recipes in the database section, and on any item see every recipe it's an ingredient in via the Tradeskills tab. Pin frequently-used combines as favorites. See your success and failure odds on any combine from your skill and crafting gear, and build an optimized step-by-step **leveling plan** — fastest or cheapest — to raise any tradeskill to your target.
