...
import OverlayPopoutToggle from './OverlayPopoutToggle'
...
export default function CharacterSwitcher(): React.ReactElement | null {
  ...
  return (
    <div className="no-drag flex items-center gap-1.5 px-2 pt-1 pb-2">
      <div ref={containerRef} className="relative min-w-0 flex-1">
        ...
        {open && (
          <div
            className="absolute left-0 right-0 z-40 mt-1 overflow-hidden rounded shadow-lg"
            style={{
