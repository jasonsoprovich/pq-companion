            ...
            <>
              ...
              <label className="flex items-start gap-2 cursor-pointer">
                ...
                <span>
                  ...
                  <span className="block text-xs" style={{ color: 'var(--color-muted-foreground)' }}>
                    Also alerts for items other characters wishlisted — including no-drop items,
                    for swapping in an alt to loot for them. Off by default: most players only
                    want reminders about their active character.
                  </span>
                </span>
              </label>
              ...
              <div>
                ...
                <input
                  ...
                  disabled={!prefs.enabled}
                  className="w-full rounded px-2 py-1 text-xs outline-none font-mono disabled:opacity-50"
                  style={inputStyle}
                />
                <p className="mt-1 text-[10px]" style={{ color: 'var(--color-muted)' }}>
                  {'{item}'} and {'{character}'} expand to the matched item and the wishlisting
                  character.
                </p>
              </div>
