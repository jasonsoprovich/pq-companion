...
import { Users, TrendingUp, Package, BookOpen, Library, KeyRound, ListChecks, Star, Hourglass, Wand2 } from 'lucide-react'
...
const TABS: CharactersTab[] = [
  ...
  { to: '/characters/upgrades', label: 'Gear Upgrades', icon: <Wand2 size={14} /> },
