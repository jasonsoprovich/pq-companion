 ...
 *
 * Driven by EQ /keys output: the backend parses /keys log lines into
 * keyring_entries rows; this component renders the union of the
 * keyring_data master list and the selected character's owned set.
 */
...
function KeyringRow({ entry, owned }: KeyringRowProps): React.ReactElement {
  ...
  // the eye lands on owned ones first.
  return (
    <div
