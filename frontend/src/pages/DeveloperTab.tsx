...
export default function DeveloperTab(): React.ReactElement {
  return (
    ...
    >
      ...
      <div
        className="mb-4 flex items-start gap-2 rounded px-3 py-2 text-xs"
        style={{
      ...
      >
        ...
        <p>
          ...
          and column names are the upstream Project Quarm schema and may change
          between releases — shared queries may need updating after database
          refreshes. Press <kbd>Ctrl+Shift+D</kbd> on this page again to hide
          this tab.
        </p>
      </div>

      <p className="text-sm" style={{ color: 'var(--color-muted-foreground)' }}>
        SQL sandbox and schema diagrams are coming next.
      </p>
    </section>
  )
}
